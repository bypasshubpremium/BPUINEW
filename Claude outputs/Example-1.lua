...
local Window = BPUI:CreateWindow({
    ...
    ConfirmClose = true,                   -- ask before destroying
    Resizable = nil,                       -- nil = PC only
    Search = true,                         -- search field in the top bar
...
-- Long option lists get a filter box automatically (more than six options)
...
---------------------------------------------------------------------------
-- Locking, dialogs and window control
---------------------------------------------------------------------------
